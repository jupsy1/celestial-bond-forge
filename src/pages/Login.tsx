...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      {inApp ? (
        <div className="rounded-md border border-yellow-500/40 bg-yellow-500/10 px-4 py-3 text-sm text-yellow-100 mb-6 text-center">
          You’re using <b>{inApp}</b>’s in-app browser.  
          Google and Facebook login may not work here.  
          <br />
